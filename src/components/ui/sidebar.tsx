...
function SidebarProvider({
  ...
  // Este é o estado interno da barra lateral (sidebar).
  // Usamos openProp e setOpenProp para controle vindo de fora do componente.
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Define o cookie para manter o estado da barra lateral persistido.
      document.cookie = `${SIDEBAR_COOKIE_NAME}=${openState}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}`
    },
    [setOpenProp, open]
  )

  // Auxiliar para alternar a exibição da barra lateral.
  ...
  // Adicionamos um estado para que possamos definir data-state="expanded" ou "collapsed".
  // Isso torna mais fácil estilizar a barra lateral usando classes do Tailwind.
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // Ajusta o espaçamento para as variantes flutuante (floating) e embutida (inset).
          variant === "floating" || variant === "inset"
